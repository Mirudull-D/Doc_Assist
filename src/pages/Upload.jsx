...
import { Upload as UploadIcon, Folder, File, X, Info } from 'react-feather'
    ...
    <div data-aos="fade-up" className="max-w-3xl mx-auto">
      ...
      {files.length > 0 && (
        <div className="mt-8">
          ...
          <div className="mt-6">
            <button className="w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 flex items-center justify-center">
      ...
      <div className="mt-12 bg-blue-50 p-6 rounded-xl">
        <h3 className="text-lg font-medium text-blue-800 mb-3 flex items-center">
          <Info className="mr-2" size={18} /> How it works
        </h3>
